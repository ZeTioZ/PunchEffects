...
{	
	public boolean isRegionPvp(Player player)
	{
		...
		final World weWorld = BukkitAdapter.adapt(player.getWorld());
		final RegionManager regions = container.get(weWorld);
		final Map<String, ProtectedRegion> regionsMap = regions.getRegions();
